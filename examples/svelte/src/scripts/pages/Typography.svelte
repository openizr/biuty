...
<script lang="ts">
  ...
  import { UIP, UITitle, UILink } from 'biuty/svelte';
...
<div class="vgap-5">
  <main class="ui-page ui-block cols-1 vgap-5">
    ...
    <UIP
      label="ui-p ui-p ui-p ui-p ~ui-p italic~ _ui-p underline_ **ui-p strong** *ui-p emphasis* ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p ui-p"
    />
    <UILink
      href="/"
      target="_blank"
