...
describe('markdown', () => {
  ...
  describe('light', () => {
    ...
    test('image', () => {
      expect(markdown('![title](https://path/to/image)')).toBe('![title](https://path/to/image)');
    });
    ...
    test('link', () => {
      expect(markdown('test [my link](https://test.com|"my title") test')).toBe('test <a class="ui-link" href="https://test.com" title="my title">my link</a> test');
    });
